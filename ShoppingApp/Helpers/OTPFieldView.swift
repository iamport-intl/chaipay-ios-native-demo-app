...
//  OTPFieldView
//
//  Created by Sireesha Neelapu on 08/11/21.
//
...
public class OTPFieldView: UIView {
    ...
    @IBOutlet var firstTextField: OTPTextField! {
        didSet {
            firstTextField.tag = 1
            setupTextField(firstTextField)
        }
    }
    @IBOutlet var secondTextField: OTPTextField! {
        didSet {
            secondTextField.tag = 2
            setupTextField(secondTextField)
        }
    }
    @IBOutlet var thirdTextField: OTPTextField!{
        didSet {
            thirdTextField.tag = 3
            setupTextField(thirdTextField)
        }
    }
    @IBOutlet var fourthTextField: OTPTextField!{
        didSet {
            fourthTextField.tag = 4
            setupTextField(fourthTextField)
        }
    }
    @IBOutlet var fifthTextField: OTPTextField!{
        didSet {
            fifthTextField.tag = 5
            setupTextField(fifthTextField)
        }
    }
    @IBOutlet var sixthTextField: OTPTextField!{
        didSet {
            sixthTextField.tag = 6
            setupTextField(sixthTextField)
        }
    }
    ...
    func setupTextField(_ otpField: OTPTextField) {
        ...
        otpField.initalizeUI(forFieldType: .roundedCorner)
    }
