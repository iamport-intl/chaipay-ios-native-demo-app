...
#ifndef PORTONESDK_SWIFT_H
#define PORTONESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PortoneSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10PortoneSDK22CheckoutViewController")
...
@interface CheckoutViewController (SWIFT_EXTENSION(PortoneSDK)) <WKDownloadDelegate, WKNavigationDelegate, WKUIDelegate>
